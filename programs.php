...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
			<div class="col-md-3">
			    <ul class="nav nav-pills nav-stacked affix" data-spy="affix" data-offset-bottom="200">
      		      <li class="nav-header">Programs</li>
      		      <li><a href="#colloquiumSeries">Colloquium Series</a></li>
      		      <li><a href="#diversityInitiatives">Diversity Initiatives</a></li>
      		      <li><a href="#grassrootsCampaigns">Grassroots Campaigns</a></li>
      		 <!--     <li><a href="#scientificResearch">Scientific Research</a></li> -->
      		      <li><a href="#seminarsWorkshops">Seminars & Workshops</a></li>
      		      <li><a href="#serviceLearning">Service Learning</a></li>
      		      <li><a href="#socialEvents">Social Events</a></li>
      		      <li><a href="#summerEnrichment">Summer Enrichment</a></li>
      		    </ul>
			 </div>

          <div class="col-md-9">
            <div class="panel" id="colloquiumSeries">
                <div class="panel-heading"><strong>Colloquium Series</strong></div>
                <div class="panel-body">
                    <p>
                        SEEC hosts a popular environmental colloquium series, in which renowned environmental scholars and leaders visit the North Carolina School of Science and Mathematics to present research, speak about their particular experiences, and inspire students.
                        This is a great opportunity for young adults to become exposed to the interdisciplinary field of environmental science and obtain career advice from leading environmentalists. Our colloquium series is open to the public.
                    </p>
                   ...
                   <div class="container-fluid">
                     <h3 class="text-center">Stuart Pimm</h3>
                     <div class="row">
					...
					<hr>
                   <div class="container-fluid">
                     <h3 class="text-center">Jedediah Purdy</h3>
                     <div class="row">
            ...
            <div class="panel" id="diversityInitiatives">
                <div class="panel-heading"><strong>Diversity Initiatives</strong></div>
                <div class="panel-body">
                  <div class="container-fluid">
                  <div class="row">
                    <img class="img-responsive" src="static/img/programs/diversityInitiatives/diversityInitiatives1.jpg" alt=""/>
...
<!--
            <div class="panel" id="scientificResearch">
                ...
                <div class="panel-body">
                  <img class="img-responsive" src="static/img/programs/scientificResearch/scientificResearch1.jpg" alt=""/>

                    <p>
                        Are you: interested in environmental science research, academically talented, and above the age of 16? We are currently working to connect high school students with exciting internships and mentors both during the summer of 2017 and the following 17-18
                        school year. These laboratory opportunities will be open exclusively to students applying through SEEC. We are particularly seeking underrepresented minorities in STEM or low-income students, but all local high school students
                        above the age of 16 are encouraged to apply. Check our Facebook and Wordpress page for any available SEEC-coordinated research experiences in the Triangle! 
                    </p>
                    <p>
                      In the past, SEEC has successfully connected high school students with opportunities to work at the Nicholas School of the Environment at Duke University for 6-week summer research internships.
                    </p>
                </div>
            </div>
-->
            <div class="panel" id="seminarsWorkshops">
                <div class="panel-heading"><strong>Seminars and Workshops</strong></div>
                <img class="img-responsive" src="static/img/programs/seminarsWorkshops/seminarsWorkshops1.jpg" alt=""/>

                <div class="panel-body">
                  <p>
                    SEEC hosts special seminars and workshops on various topics for various ages, from basic energy science to interdisciplinary environmental policy. For example, in the past, SEEC has led a weekly half-credit “Environmental Policy” seminar
                    for advanced students at the North Carolina School of Science and Mathematics that explores the complex relationships between environmental science, philosophy, law, and policy through guided discussions. Students examined Duke University
                    law professor Jedediah Purdy’s After Nature: A Politics for the Anthropocene and concluded the seminar with an engaging talk from Professor Purdy himself. The primary goal of this unique educational program is to attract gifted students
                    to environmental studies, such that America’s future leaders are well-versed in environmental thought in order to effectively solve environmental issues.
                  </p>
                </div>
            </div>

            <div class="panel" id="serviceLearning">
                <div class="panel-heading"><strong>Service Learning</strong></div>
                <div class="panel-body">
            ...
            <div class="panel" id="socialEvents">
                <div class="panel-heading"><strong>Social Events</strong></div>
                <div class="panel-body">
                  <img class="img-responsive" src="static/img/programs/socialEvents/socialEvents1.jpg" alt=""/>
		 ...
		 <div class="container-fluid">
            ...
            <div class="panel" id="summerEnrichment">
                <div class="panel-heading"><strong>Summer Enrichment</strong></div>
                <div class="panel-body">
                  <img class="img-responsive" src="static/img/programs/summerEnrichment/summerEnrichment1.jpg" alt=""/>

                  <p>
                    The popular annual NatureWay Summer Camp is made possible by a partnership between SEEC and NatureWay Charity, a nonprofit organization founded in 2012 by Jenny Liu and Frances Liu. Together, we offer comprehensive hands-on environmental
                    science curriculum to elementary school children at no price. Every year we hire a talented batch of counselors from many different schools, with each leader having expertise in environmental topics like Earth science, aquatic ecology,
